...
💻 Я — веб-разработчик с почти 2 годами опыта, в основном работаю с **Vue** и **Nuxt**, но также знаком с **React** и **Flutter**. Люблю чистую архитектуру, адаптивную вёрстку и писать код, который легко поддерживать.

## 🧠 Soft Skills

- Ответственный и внимательный к деталям
- Вежливый, честный и открытый в общении
- Быстро обучаюсь и всегда стремлюсь к росту
- Работаю на результат

## 🔨 Примеры проектов

- [rtp.ru](https://rtp.ru) — фронтенд на Nuxt, интеграция с API, адаптив
- [kingfit.ru](https://kingfit.ru) — сборка на Webpack, вёрстка и логика с нуля, адаптив
